// src/data/progetti.ts
// Porta esatta da app/composables/useProgetti.ts — dati reali dei 12 progetti.
// Testo Lorem ipsum in INTRO/SEZIONI/METODO: placeholder reale, stato attuale del sito, non modificare.
