...
<template>
  <section class="flex flex-col items-center gap-bc-xl lg:gap-bc-2xl py-bc-2xl lg:py-bc-4xl px-bc-page max-w-bc-wrap mx-auto">
    <h1 class="font-garamond text-[36px] md:text-[44px] lg:text-bc-h1 font-semibold text-center text-bc-black tracking-[0.02em] max-w-[908px]">
    ...
    <p class="font-garamond text-bc-body1 font-normal text-center text-bc-black max-w-[440px]">
