<!-- Figma: 590:1571 section5 — griglia 4 col, gap-x 24px / gap-y 48px -->
<!-- Card-vertical: img aspect 326/406 | Card-horizontal: img aspect 326/217 -->
<!-- Testo: PRJ (PS 14 light) + Committente (PS 14 light) + Nome (Garamond 24 semibold) -->
