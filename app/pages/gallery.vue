  ...
  <div>
    ...
    <section class="w-full border-b border-bc-black px-bc-page py-bc-4xl">
      <div class="mx-auto max-w-[908px] flex flex-col items-center gap-bc-2xl text-center">
        <h1 class="font-garamond text-[36px] md:text-[44px] lg:text-bc-h1 font-semibold text-bc-black tracking-[0.02em] leading-[1.2]">
          Gallery fotografica
        </h1>
        <p class="font-garamond text-bc-sub font-normal text-bc-black tracking-[0.02em] max-w-[438px]">
