...
import { c as createError$1, k as parseURL, e as encodePath, l as decodePath, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, q as klona, s as sanitizeStatusCode, r as defuFn, t as getContext, $ as $fetch$1, v as baseURL, x as defu, y as createHooks, z as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-ovgzBX-q.mjs')
  },
  {
    name: "studio",
    path: "/studio",
    component: () => import('./studio-D-XpB5Ve.mjs')
  },
  {
    name: "gallery",
    path: "/gallery",
    component: () => import('./gallery-DFKAu7nK.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-D92CVCre.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BlRgbYQs.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BIt7jL-n.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BLQ61ge-.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, asyncDataDefaults as c, createError as d, entry_default as default, useRouter as e, encodeRoutePath as f, nuxtLinkDefaults as g, navigateTo as n, resolveRouteObject as r, useAppConfig as u };
