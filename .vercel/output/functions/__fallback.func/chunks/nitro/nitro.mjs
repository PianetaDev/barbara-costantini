...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "714dbf34-b681-46bb-b74b-cf59bdd35697",
...
const _GNEPD_ = defineCachedEventHandler(async (event) => {
...
const _OdOGwb = lazyEventHandler(() => {
...
const _lazy_3rdx1s = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_3rdx1s, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _GNEPD_, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _OdOGwb, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_3rdx1s, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, parseQuery as A, withTrailingSlash as B, withoutTrailingSlash as C, listener as D, destr as a, buildAssetsURL as b, createError$1 as c, defineRenderHandler as d, encodePath as e, getRouteRules as f, getQuery as g, getResponseStatusText as h, getResponseStatus as i, useNitroApp as j, parseURL as k, decodePath as l, hasProtocol as m, isScriptProtocol as n, joinURL as o, publicAssetsURL as p, klona as q, defuFn as r, sanitizeStatusCode as s, getContext as t, useRuntimeConfig as u, baseURL as v, withQuery as w, defu as x, createHooks as y, executeAsync as z };
